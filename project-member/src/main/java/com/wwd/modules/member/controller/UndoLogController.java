...
import com.wwd.modules.member.dto.UndoLogDTO;
import com.wwd.modules.member.excel.UndoLogExcel;
import com.wwd.modules.member.service.UndoLogService;
...
public class UndoLogController {
    ...
    @RequiresPermissions("menber:undolog:page")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("menber:undolog:export")
